...
**Текущий этап:** развёртывание — этап E завершён; далее [этап F](docs/deployment-plan.md#этап-f--definition-of-done) (Definition of Done).
**Текущая неделя (после deploy):** [Неделя 1 — Nitro и первый backend](../docs/roadmap-12-weeks.md#неделя-1--nitro-и-первый-backend).
