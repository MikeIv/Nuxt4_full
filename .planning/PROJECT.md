...
**Текущая неделя:** [4 — Better Auth + RBAC](../docs/roadmap-12-weeks.md#неделя-4--better-auth--rbac--protected-routes-старт-сегодня) — план 2026-06-10.
...
| БД       | —                           | PostgreSQL + Prisma (нед. 2)  |
| Auth     | —                           | Better Auth + Prisma (нед. 4) |
