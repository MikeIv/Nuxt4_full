...
**Текущий этап:** развёртывание — этап C завершён; далее [этап D](docs/deployment-plan.md#этап-d--локальное-окружение) (`.env`, build, lint).
**Следующий после deploy:** [Неделя 1 — Nitro и первый backend](../docs/roadmap-12-weeks.md#неделя-1--nitro-и-первый-backend).
...
- Установка: `d:\_WEB\_Work\_Cursor-rules-template\` / `INSTALL-NUXT-VUE.md`
